...
api = ApiClient(token="BBFF-dl4iMp3rt8ZGYV8kuJOx1qgDaiXC1C", base_url="http://things.ubidots.com/api/v1.6/",apikey="BBFF-4dc3e95dfb69c92faf9c517d5dfeb09d27d")
...
def llenar_arreglo_variables(dic):
    dic={"distancia":variable_distancia.get_values(1)[0]["value"],"magnetismo":variable_magnetismo.get_values(1)[0]["value"],"obstaculo":variable_obstaculo.get_values(1)[0]["value"]}
    return  dic
